...
import repository.AttendanceRepositoryImp;
...
public class Module extends AbstractModule {
    ...
    public void configure() {
        ...
        bind(EmployeeRepository.class).to(EmployeeRepositoryImp.class).asEagerSingleton();
        bind(AttendanceRepository.class).to(AttendanceRepositoryImp.class).asEagerSingleton();
        bind(AdminInitializer.class).asEagerSingleton();
    }
