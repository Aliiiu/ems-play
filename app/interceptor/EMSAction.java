...
public class EMSAction extends Action.Simple{
    ...
    @Singleton
    @Inject
    public EMSAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures){
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(EMSAction.class, "responsesTimer"));
    }
